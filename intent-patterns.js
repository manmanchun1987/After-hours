...
(function (global) {
  ...
  var PATTERNS = {
    enter_door: [/推門/, /推開門/, /開門/, /開門啦/, /開門吖/, /開門喎/, /開門呀/, /開門先/, /入去/, /入嚟/, /進來/, /進去/, /進入/, /推入/, /入門/, /進門/, /入去先/, /入去未/, /入去睇/, /入去睇吓/, /入去啦/, /進去看/, /進去看看/, /行入/, /走入/, /踏入/, /我入/, /我入去/, /我哋入去/, /而家入去/, /行過去先/, /過門/, /打開門/, /入房/, /行入去/, /推開/, /\benter\b/i, /\bgo in\b/i, /open( the)? door/i, /push( the)? door/i, /let me in/i],
    wait: [/猶豫/, /停一秒/, /停一停/, /停低/, /唔敢/, /再推/, /等等/, /等等先/, /企喺度/, /企喎度/, /站住/, /等陣/, /等陣先/, /等一等/, /等我吓/, /未準備/, /未準備好/, /再諗/, /再諸/, /諗清楚/, /諸清楚/, /諗吓/, /諸吓/, /諗一諗/, /諸一諸/, /我要諗/, /我要諸/, /未夠膽/, /未定/, /未決定/, /慢啲/, /慢住/, /等吓先/, /hold on/i, /\bwait\b/i, /not ready/i, /hang on/i],
    ask_want: [/你想我點/, /你想要/, /我想知你想/, /我應該點/, /應該做咩/, /而家應該/, /而家點算/, /而家點做/, /而家做咩好/, /點樣先/, /點先好/, /點先得/, /點行先/, /點算/, /點算好/, /教我/, /指引/, /我做乜/, /你要我/, /跟住做咩/, /跟住點/, /下一步/, /你想我做咩/, /你話我點/, /我而家做咩/, /what do you want/i, /what should i/i, /what now/i, /what next/i],
    agree: [/^(好|係|係呀|係喎|得|得啦|嗯|繼續|好呀|得喎|ok|okay|yes|y)$/i, /好啊/, /可以/, /同意/, /跟你/, /聽你/, /我跟你/, /係咁/, /就咁/],
    refuse: [/唔入去/, /唔入/, /唔要/, /不要/, /拒絕/, /鎖門/, /關門/, /走先/, /閃/, /唔得/, /算吧/, /算了/, /唔敢入/, /我走/, /離開/, /\bno\b/i, /唔想入去/, /唔想入/, /唔想去/, /我唔入/, /唔想推/, /唔推/, /我唔去/, /我唔想而家入/, /而家唔入/, /而家唔想入/, /^唔想$/, /唔想啦/, /我唔想推門/, /not going in/i],
  ...
  var SOFT_LEXICON = {
    enter_door: ["推門","開門","入去","入嚟","進去","進入","行入","開門啦","開門吖","開門喎","我入","入去先","進去看","入去啦","開門先","行入去"],
    wait: ["等等","停","猶豫","停低","等陣","未準備","再諗","諗吓","等等先","諗一諗","等陣先","再諸","諸吓"],
    refuse: ["唔入","走先","閃","關門","離開","我走","唔想入","唔推","我唔入","唔想","我唔想推門","唔入去","而家唔想入"],
