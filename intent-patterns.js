/**
 * IntentPatterns (split1ae) — Lane A. Soft-pass lexicon + regex. No exact-key gate.
...
(function (global) {
  ...
  var PATTERNS = {
    ...
    refuse: [/唔入/, /我唔入/, /唔想推門/, /我唔想/, /\bno\b/i, /唔得/, /我唔去/, /唔想入/, /我唔想入去/, /唔開門/, /我企喺度/],
  ...
  var SOFT_LEXICON = {
    ...
    ask_memory: ["記得", "講返", "記低", "聽低", "寫低", "抄低", "複述", "頭先講", "講過未", "記住", "講過有未", "複述返", "記唔記得", "聽清楚", "頭先喪句", "講多次", "聽住", "記著", "記着", "覆述", "你聽到未", "記低咑", "覆述一遍", "講返一次", "記住未呀", "聽低咑", "講返俾我聽", "記著咑", "記低咋", "聽低咋", "覆述俾我聽"]
  };
  var KEY_SYNONYMS = {
    ...
    apologize: ["sorry"],
    ask_memory: ["記得", "講返", "記低", "頭先", "記唔記得", "聽清楚", "複述", "聽住", "記著", "記着", "覆述", "記低咑", "覆述一遍", "記住未呀", "聽低咑", "記著咑", "記低咋", "聽低咋"]
  };
  var ACCEPTANCE_SOFT = [
  ...
  var api = {INTENTS:INTENTS,PATTERNS:PATTERNS,SOFT_LEXICON:SOFT_LEXICON,KEY_SYNONYMS:KEY_SYNONYMS,ACCEPTANCE_SOFT:ACCEPTANCE_SOFT,version:"split1ae"};
