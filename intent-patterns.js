...
(function (global) {
  ...
  var PATTERNS = {
    enter_door: [/推門/, /推開門/, /開門/, /開門啦/, /開門吖/, /開門喎/, /開門呀/, /開門先/, /入去/, /入嚟/, /進來/, /進去/, /進入/, /推入/, /入門/, /進門/, /入去先/, /入去未/, /入去睇/, /入去睇吓/, /入去睇下/, /入去啦/, /進去看/, /進去看看/, /行入/, /走入/, /踏入/, /我入/, /我入去/, /我哋入去/, /而家入去/, /行過去先/, /行過去/, /過門/, /打開門/, /打開條門/, /推開條門/, /入房/, /行入去/, /推開/, /去入面/, /入去辦公室/, /入去見/, /門打開/, /入去先啦/, /入去睇下先/, /我行入/, /\benter\b/i, /\bgo in\b/i, /open( the)? door/i, /push( the)? door/i, /let me in/i, /我入去先啦/, /入去睇一睇/, /入去望吓/, /行入去先/, /推吓門/, /推一推門/, /門推開/, /入去先至算/, /入去見吓/],
    wait: [/猶豫/, /停一秒/, /停一停/, /停低/, /唔敢/, /再推/, /等等/, /等等先/, /企喺度/, /企喎度/, /站住/, /等陣/, /等陣先/, /等一等/, /等我吓/, /等一吓/, /等我一陣/, /未準備/, /未準備好/, /未想好/, /再諗/, /再諸/, /再睇吓/, /諗清楚/, /諸清楚/, /諗吓/, /諸吓/, /諗一諗/, /諸一諸/, /我要諗/, /我要諸/, /我再諗/, /未夠膽/, /未定/, /未決定/, /慢啲/, /慢住/, /等吓先/, /遲啲先/, /未得/, /hold on/i, /\bwait\b/i, /not ready/i, /hang on/i, /等我一陣先/, /我未諗好/, /我未諗清楚/, /停一停先/, /企定先/, /唔好急/, /慢啲先/, /我再睇清楚/],
    ask_want: [/你想我點/, /你想要/, /我想知你想/, /我應該點/, /應該做咩/, /而家應該/, /而家點算/, /而家點做/, /而家做咩好/, /而家點先/, /點樣先/, /點先好/, /點先得/, /點行先/, /點算/, /點算好/, /點算先/, /教我/, /指引/, /我做乜/, /你要我/, /你要我點/, /跟住做咩/, /跟住點/, /跟住呢/, /下一步/, /你想我做咩/, /想我做咩/, /你話我點/, /你話點/, /我而家做咩/, /我而家點/, /what do you want/i, /what should i/i, /what now/i, /what next/i, /跟住我做咩/, /而家我應該點/, /你想我點做/, /點先入/, /點樣入去/, /我跟住點做/, /話我知點/],
  ...
  var SOFT_LEXICON = {
    enter_door: ["推門","開門","入去","入嚟","進去","進入","行入","開門啦","開門吖","開門喎","我入","入去先","進去看","入去啦","開門先","行入去","推開條門","入去睇下","行過去","去入面","入去睇一睇","推吓門","入去望吓","行入去先"],
    wait: ["等等","停","猶豫","停低","等陣","未準備","再諗","諗吓","等等先","諗一諗","等陣先","再諸","諸吓","等一吓","未想好","再睇吓","遲啲先","未諗好","停一停先","唔好急","慢啲先"],
    refuse: ["唔入","走先","閃","關門","離開","我走","唔想入","唔推","我唔入","唔想","我唔想推門","唔入去","而家唔想入","而家唔去","唔入啦","我唔想入去"],
    agree: ["好","係","繼續","得","ok","yes"],
    flirt: ["近啲","坐近","想要你","錫我"],
    ask_want: ["你想","點做","指引","教我","應該點","想我點","應該做咩","而家應該","點行先","跟住點","點算好","你話我點","你要我點","跟住呢","我而家點","跟住我做咩","而家我應該點","話我知點","點先入"],
    apologize: ["對唔住","唔好意思","抱歉","sorry","對唔住喎"],
    off_topic: ["天氣","食飯","足球","chatgpt","ai","程式","幾多度","落雨","幾點鐘","星期幾","股市"],
    ask_memory: ["記得","頭先","記唔記得","我講過","頭先講咩","我頭先講過","頭先嗰句","我頭先話","你有冇聽","記得我講過","頭先我話","記唔記得門口","頭先我話想入","記得我話過","聽到我頭先","頭先講過想入","記得我想推門"]
  };
  var KEY_SYNONYMS = {
