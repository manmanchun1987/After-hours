/**
 * IntentPatterns (split1m) — Lane A. Soft-pass lexicon + regex. No exact-key gate.
 */
(function (global) {
  "use strict";
  ...
  var SOFT_LEXICON = {
    ...
    ask_memory: ["記得","頭先","記唔記得","我講過","頭先講咩","我頭先講過","頭先嗰句","我頭先話","你有冇聽","記得我講過","頭先我話","記唔記得門口","頭先我話想入","記得我話過","聽到我頭先","頭先講過想入","記得我想推門","記住我講","記住頭先","頭先想入","記得我話想推","有冇記住","你有冇記住我講","記住未","你記得未呀","你記唔記得我想開門","我頭先話開門","有冇記住我頭先","頭先嗰句你聽到"]
  };
  var KEY_SYNONYMS = {
  ...
  var ACCEPTANCE_SOFT = [
    ...
    {text:"你有冇記住",intent:"ask_memory"},{text:"今日熱唔熱",intent:"off_topic"},{text:"你有冇記住我講",intent:"ask_memory"},{text:"你記得未呀",intent:"ask_memory"},{text:"你記唔記得我想開門",intent:"ask_memory"},{text:"我頭先話開門",intent:"ask_memory"},{text:"我要諳吓",intent:"wait"},{text:"頭先嗰句你聽到未",intent:"ask_memory"}
  ];
  var api = {INTENTS:INTENTS,PATTERNS:PATTERNS,SOFT_LEXICON:SOFT_LEXICON,KEY_SYNONYMS:KEY_SYNONYMS,ACCEPTANCE_SOFT:ACCEPTANCE_SOFT,version:"split1m"};
