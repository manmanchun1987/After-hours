/**
 * IntentPatterns (split1ag) — Lane A. Soft-pass lexicon + regex. No exact-key gate.
 * T2 thicken: memory 口語（頭先嗎啲你記未／有冇聽返我講／你抄低未呀／覆述返俾我聽／記住晒未／聽返晒未呀／講返我頭先講嗎句／有冇記返）
...
(function (global) {
  ...
  var SOFT_LEXICON = {
    enter_door: ["開門", "入去", "推門", "進去", "入去先", "開門先", "推開", "入去睇下", "打開門", "開門吧", "入去咯", "推門入去", "開門入去", "行入嚃"],
    ...
    ask_memory: ["記得", "講返", "記低", "聽低", "寫低", "抄低", "複述", "頭先講", "講過未", "記住", "講過有未", "複述返", "記唔記得", "聽清楚", "頭先喪句", "講多次", "聽住", "記著", "記着", "覆述", "你聽到未", "記低咑", "覆述一遍", "講返一次", "記住未呀", "聽低咑", "講返俾我聽", "記著咑", "記低咋", "聽低咋", "覆述俾我聽", "記低晒", "聽晒未", "聽返頭先", "覆述過未", "頭先嗎句", "記晒未", "頭先嗎啲", "聽返我講", "抄低未呀", "覆述返俾我聽", "記住晒", "聽返晒", "有冇記返", "記返未", "聽返未"]
  };
  var KEY_SYNONYMS = {
    ...
    apologize: ["sorry"],
    ask_memory: ["記得", "講返", "記低", "頭先", "記唔記得", "聽清楚", "複述", "聽住", "記著", "記着", "覆述", "記低咑", "覆述一遍", "記住未呀", "聽低咑", "記著咑", "記低咋", "聽低咋", "記低晒", "聽晒", "聽返", "覆述過", "頭先嗎句", "記晒", "頭先嗎啲", "記返", "記住晒", "聽返晒"]
  };
  var ACCEPTANCE_SOFT = [
  ...
  var api = {INTENTS:INTENTS,PATTERNS:PATTERNS,SOFT_LEXICON:SOFT_LEXICON,KEY_SYNONYMS:KEY_SYNONYMS,ACCEPTANCE_SOFT:ACCEPTANCE_SOFT,version:"split1ag"};
