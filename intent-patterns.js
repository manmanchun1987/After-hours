/**
 * IntentPatterns (split1t) — Lane A. Soft-pass lexicon + regex. No exact-key gate.
 */
(function (global) {
  "use strict";
  ...
  var KEY_SYNONYMS = {
    ...
    ask_memory: ["記得","頭先","記住","記低","同你講","聽低","寫低","抄低","記住咋","複述"]
  };
  var ACCEPTANCE_SOFT = [
    ...
    {text:"抄低未",intent:"ask_memory"},{text:"記住咋未",intent:"ask_memory"},{text:"你記低咗未",intent:"ask_memory"},{text:"聽到未呀",intent:"ask_memory"},{text:"複述吓",intent:"ask_memory"}
  ];
  var api = {INTENTS:INTENTS,PATTERNS:PATTERNS,SOFT_LEXICON:SOFT_LEXICON,KEY_SYNONYMS:KEY_SYNONYMS,ACCEPTANCE_SOFT:ACCEPTANCE_SOFT,version:"split1t"};
