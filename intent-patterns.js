...
(function (global) {
  ...
  var SOFT_LEXICON = {
    ...
    ask_memory: ["記得", "講返", "記低", "聽低", "寫低", "抄低", "複述", "頭先講", "講過未", "記住", "講過有未", "複述返", "記唔記得", "聽清楚", "頭先嗰句", "講多次", "聽住", "記著", "記着", "覆述", "你聽到未", "記低咖", "覆述一遍", "講返一次", "記住未呀", "聽低咖", "講返俾我聽", "記著咖"]
  };
  var KEY_SYNONYMS = {
    ...
    ask_want: ["想", "應該", "而家點"],
    apologize: ["sorry"],
    ask_memory: ["記得", "講返", "記低", "頭先", "記唔記得", "聽清楚", "複述", "聽住", "記著", "記着", "覆述", "記低咖", "覆述一遍", "記住未呀", "聽低咖", "記著咖"]
  };
  var ACCEPTANCE_SOFT = [
