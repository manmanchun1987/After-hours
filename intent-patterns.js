/**
 * IntentPatterns (split1o) — Lane A. Soft-pass lexicon + regex. No exact-key gate.
 */
(function (global) {
  "use strict";
  ...
  var SOFT_LEXICON = {
    ...
    ask_memory: ["記得","頭先","記唔記得","我講過","頭先講咩","我頭先講過","頭先嗰句","我頭先話","你有冇聽","記得我講過","頭先我話","記唔記得門口","頭先我話想入","記得我話過","聽到我頭先","頭先講過想入","記得我想推門","記住我講","記住頭先","頭先想入","記得我話想推","有冇記住","你有冇記住我講","記住未","你記得未呀","你記唔記得我想開門","我頭先話開門","有冇記住我頭先","頭先嗰句你聽到","記低","有冇記低","記低未","頭先同你講","我頭先同你講","有円記低","你有冇記低","記低我講","頭先同你講過"]
  };
  var KEY_SYNONYMS = {
  ...
  var api = {INTENTS:INTENTS,PATTERNS:PATTERNS,SOFT_LEXICON:SOFT_LEXICON,KEY_SYNONYMS:KEY_SYNONYMS,ACCEPTANCE_SOFT:ACCEPTANCE_SOFT,version:"split1o"};
