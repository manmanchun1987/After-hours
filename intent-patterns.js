...
(function (global) {
  ...
  var SOFT_LEXICON = {
    ...
    wait: ["等等","停","猶豫","停低","等陣","未準備","再諗","諗吓","等等先","諗一諗","等陣先","再諸","諸吓","等一吓","未想好","再睇吓","遲啲先","未諗好","停一停先","唔好急","慢啲先","畀我諗","再企一陣","遲啲入","未得咁快"],
    ...
    ask_memory: ["記得","頭先","記唔記得","我講過","頭先講咩","我頭先講過","頭先嗰句","我頭先話","你有冇聽","記得我講過","頭先我話","記唔記得門口","頭先我話想入","記得我話過","聽到我頭先","頭先講過想入","記得我想推門","記住我講","記住頭先","頭先想入","記得我話想推","有冇記住"]
  };
  var KEY_SYNONYMS = {
  ...
  var ACCEPTANCE_SOFT = [
    ...
    {text:"你有冇記住",intent:"ask_memory"},{text:"今日熱唔熱",intent:"off_topic"}
  ];
  var api = {INTENTS:INTENTS,PATTERNS:PATTERNS,SOFT_LEXICON:SOFT_LEXICON,KEY_SYNONYMS:KEY_SYNONYMS,ACCEPTANCE_SOFT:ACCEPTANCE_SOFT,version:"split1l"};
