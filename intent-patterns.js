/**
 * IntentPatterns (split1y) — Lane A. Soft-pass lexicon + regex. No exact-key gate.
 * T2 thicken: memory + enter/wait/ask_want 模糊／錯字／口語（聽清楚未／頭先嗰句／開門先／等陣／而家點）
 */
(function (global) {
  "use strict";
  ...
  var SOFT_LEXICON = {
    ...
    ask_memory: ["記得", "講返", "記低", "聽低", "寫低", "抄低", "複述", "頭先講", "講過未", "記住", "講過有未", "複述返", "記唔記得", "聽清楚", "頭先嗰句", "講多次"]
  };
  var KEY_SYNONYMS = {
    ...
    ask_want: ["想", "應該", "而家點"],
    apologize: ["sorry"],
    ask_memory: ["記得", "講返", "記低", "頭先", "記唔記得", "聽清楚", "複述"]
  };
  var ACCEPTANCE_SOFT = [
  ...
  var api = {INTENTS:INTENTS,PATTERNS:PATTERNS,SOFT_LEXICON:SOFT_LEXICON,KEY_SYNONYMS:KEY_SYNONYMS,ACCEPTANCE_SOFT:ACCEPTANCE_SOFT,version:"split1y"};
