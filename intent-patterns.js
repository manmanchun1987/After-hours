/**
 * IntentPatterns (split1am) — Lane A. Soft-pass lexicon + regex. No exact-key gate.
 * T2 thicken: memory 口語（抄底／記底呀／背晒／背齊／抄齊晒／錄齊晒／收齊晒）
...
(function (global) {
  ...
  var SOFT_LEXICON = {
    enter_door: ["開門", "入去", "推門", "進去", "入去先", "開門先", "推開", "入去睇下", "打開門", "開門吧", "入去咯", "推門入去", "開門入去", "行入四"],
    wait: ["等等", "停低", "未準備", "諳吓", "等陣", "慢啲", "稍等", "等陣先", "唔急", "等我吓", "等下先", "未得閒"],
    ...
    ask_memory: ["記得", "講返", "記低", "聽低", "寫低", "抄低", "複述", "頭先講", "講過未", "記住", "講過有未", "複述返", "記唔記得", "聽清楚", "頭先喪句", "講多次", "聽住", "記著", "記着", "覆述", "你聽到未", "記低咁", "覆述一遍", "講返一次", "記住未呀", "聽低咁", "講返俾我聽", "記著咁", "記低咋", "聽低咋", "覆述俾我聽", "記低晒", "聽晒未", "聽返頭先", "覆述過未", "頭先嗎句", "記晒未", "頭先嗎啲", "聽返我講", "抄低未呀", "覆述返俾我聽", "記住晒", "聽返晒", "有冇記返", "記返未", "聽返未", "聽齊未", "記齊未", "收低未", "抄返未", "寫返未", "講返過未", "聽齊我講", "聽晒齊未", "記晒齊未", "收晒未", "收返未", "錄低未", "錄返未", "複述齊未", "講返齊未", "聽返齊", "記返齊", "記唔記晒", "抄齊未", "記低晒", "聽齊晒", "錄齊未", "收齊未", "寫齊未", "複述晒", "講晒返", "收齊", "聽齊晒", "記齊晒", "錄齊", "記底", "聽底", "寫底", "抄底", "背晒", "背齊", "抄齊晒", "錄齊晒", "收齊晒"]
  };
  var KEY_SYNONYMS = {
    ...
    apologize: ["sorry"],
    ask_memory: ["記得", "講返", "記低", "頭先", "記唔記得", "聽清楚", "複述", "聽住", "記著", "記着", "覆述", "記低咁", "覆述一遍", "記住未呀", "聽低咁", "記著咁", "記低咋", "聽低咋", "記低晒", "聽晒", "聽返", "覆述過", "頭先嗎句", "記晒", "頭先嗎啲", "記返", "記住晒", "聽返晒", "聽齊", "記齊", "收低", "抄返", "寫返", "講返過", "聽晒齊", "記晒齊", "收晒", "收返", "錄低", "錄返", "複述齊", "講返齊", "聽返齊", "記返齊", "記唔記晒", "抄齊", "聽齊晒", "錄齊", "收齊", "寫齊", "複述晒", "講晒返", "記齊晒", "記底", "聽底", "寫底", "抄底", "背晒", "背齊", "抄齊晒", "錄齊晒", "收齊晒"]
  };
  var ACCEPTANCE_SOFT = [
  ...
  var api = {INTENTS:INTENTS,PATTERNS:PATTERNS,SOFT_LEXICON:SOFT_LEXICON,KEY_SYNONYMS:KEY_SYNONYMS,ACCEPTANCE_SOFT:ACCEPTANCE_SOFT,version:"split1am"};
