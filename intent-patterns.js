/**
 * IntentPatterns (split1u) — Lane A. Soft-pass lexicon + regex. No exact-key gate.
 */
(function (global) {
  "use strict";
  ...
  var SOFT_LEXICON = {
    ...
    ask_memory: ["記得","頭先","記唔記得","我講過","頭先講咩","我頭先講過","頭先嗰句","我頭先話","你有冇聽","記得我講過","頭先我話","記唔記得門口","頭先我話想入","記得我話過","聽到我頭先","頭先講過想入","記得我想推門","記住我講","記住頭先","頭先想入","記得我話想推","有冇記住","你有冇記住我講","記住未","你記得未呀","你記唔記得我想開門","我頭先話開門","有冇記住我頭先","頭先嗰句你聽到","記低","有冇記低","記低未","頭先同你講","我頭先同你講","有円記低","你有冇記低","記低我講","頭先同你講過","聽低","寫低","聽低未","寫低未","聽低咋未","寫低咋未","記低咋未","你有冇聽低","你有冇寫低","聽低我講","寫低我講","抄低","記住咋未","複述吓","記低哂未","聽到未呀","重講一次"]
  };
  var KEY_SYNONYMS = {
    ...
    ask_memory: ["記得","頭先","記住","記低","同你講","聽低","寫低","抄低","複述","記住咋未"]
  };
  var ACCEPTANCE_SOFT = [
    ...
    {text:"抄低未",intent:"ask_memory"},{text:"記住咋未",intent:"ask_memory"},{text:"複述吓",intent:"ask_memory"},{text:"記低哂未",intent:"ask_memory"},{text:"聽到未呀",intent:"ask_memory"},
    {text:"開門啦",intent:"enter_door"},{text:"我入去先",intent:"enter_door"},{text:"等等",intent:"wait"}
  ];
  var api = {INTENTS:INTENTS,PATTERNS:PATTERNS,SOFT_LEXICON:SOFT_LEXICON,KEY_SYNONYMS:KEY_SYNONYMS,ACCEPTANCE_SOFT:ACCEPTANCE_SOFT,version:"split1u"};
